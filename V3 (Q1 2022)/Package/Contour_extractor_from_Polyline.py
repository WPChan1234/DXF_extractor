...
root = Tk()
root.withdraw()
tk.messagebox.showinfo('DXF 2 Noisemap (Contour): Introduction', 'Convert DXF polyline to Noisemap File// ' 
...
def print_entity(e):
    ...
    Bar_Output1 = "CSX="+st_x+"CSY="+st_y+"HLA=    "+End_z
    Bar_Output2 = "CEX=" + End_x + "CEY=" +End_y
...
f = asksaveasfile(mode='w', defaultextension=".pro", title='Save Noisemap Contour file as',initialfile = "Contour")
